...
text = ('However, at the time of writing, we were unable to decrypt this file since the upload URL https://appstockfolio.com/panel/upload.com '
        ...
        'These are cve numbers: CVE-1999-2012 CVE-2004-0003 CVE-2021-26855 MS-10-017 CVE-2019-1003000\n'
...
class TestTagger(TestCase):
    ...
    expected_results = {
        ...
        "CVE": ['CVE-1999-2012', 'CVE-2004-0003', 'CVE-2021-26855', 'MS-10-017', 'CVE-2019-1003000'],
